...
const ComponentItem = ({ icon, name }: any) => (
  <div draggable style={{ padding: '12px 14px', display: 'flex', alignItems: 'center', gap: 10, borderRadius: 10, cursor: 'grab', marginBottom: 8, border: '1px solid transparent', transition: 'all 0.2s' }}>
